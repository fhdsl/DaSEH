...
Our next session of DaSEH will be held online `r config::get("course_dates_online")` and in-person `r config::get("course_dates_inperson")`. For more details check out [Logistics](syllabus.html). You can register using this link: `r config::get("register_link")`!
