...
Two-week online course in R programming foundations. It is extremely helpful to have **Slack and Zoom available on the same computer** that you intend to practice in R on RStudio during the online course. This allows you to easily share your code with the instructors and others.
