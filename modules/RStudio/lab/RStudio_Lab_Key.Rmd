...
Go through the code for the plot above and change the colors in `palette` to something other than what they originally were. See https://daseh.org/resources/palette.jpg for a large list of colors. For example, you could replace blue with red.
