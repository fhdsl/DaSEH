...
```{r, fig.width=4, fig.height=3, fig.align='center'}
plt1 <- ggplot(er_visits_all, aes(x = year, y = rate, group = county)) +
          geom_point()
...
plt2 <- ggplot(er_visits_all, aes(x = year, y = rate, group = county)) +
          geom_line()
...
```{r, fig.width=4, fig.height=3, fig.align='center'}
ggplot(er_visits_all, aes(x = year, y = rate, group = county, color = county)) +
  geom_point() +
  geom_line()
```
