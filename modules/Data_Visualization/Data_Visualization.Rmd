...
But what if we wanted to look at rates by county for different genders? Let's work a little with the `er_visits_gender` dataset. This is a subset of the larger CO ER visits dataset.
