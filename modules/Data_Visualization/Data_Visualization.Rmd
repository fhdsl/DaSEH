...
Now let's create a plot using the `er_visits_gender` dataset. This dataset can be called from the `dasehr` package.

```{r, fig.width=5, fig.height=3, fig.align='center'}

#er_visits_gender <- CO_heat_ER_visits_bygender
