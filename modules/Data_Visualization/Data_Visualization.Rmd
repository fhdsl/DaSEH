...
We've worked with this dataset a bit earlier, but let's take a closer look at the dataset we've been calling `er_visits_all`. This dataset contains the number of visits to the ER for heat-related illnesses, as well as the age-adjusted rate and the 95% confidence bounds around the rate, for:
