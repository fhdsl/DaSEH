...
[Theme Cheatsheet](https://github.com/claragranell/ggplot2/blob/main/ggplot_theme_system_cheatsheet.pdf)
...
Remember the columns were colored inside with `fill`.
...
```{r, fig.width=5, fig.height=2.8, fig.align='center'}
ggplot(er_Boulder, aes(x = year, y = rate)) +
  geom_point(size = 5, color = "red", alpha = 0.5) +
  geom_line(size = 0.8, color = "black", linetype = 2)
```
