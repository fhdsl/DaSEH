...
| `tidyverse` (`purrr`)| [`mutate_if()`](https://www.rdocumentation.org/packages/tidytable/versions/0.5.8/topics/mutate_if.)| `iris |> mutate_if(is.numeric, round))`| Apply a function to specific columns in a dataframe.|
