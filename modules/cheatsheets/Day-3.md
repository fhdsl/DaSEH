...
| Base `R`| [`|>`](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/)|`df <- df |> select('variable_name')`| Funnels a data.frame through additional operations |
| `dplyr`| [`%>%`](https://www.rdocumentation.org/packages/magrittr/versions/1.5/topics/%25%26gt%3B%25)|`df <- df %>% select('variable_name')`| Funnels a data.frame through tidyverse operations |
