...
Let's upload some practice data about microplastics. Maybe we measured the level of microplastics in someone who eats a fish-based diet versus someone who eats a vegetarian diet. 
...
Effect <- pull(diet_data) %>% head(n = 6)
Effect
