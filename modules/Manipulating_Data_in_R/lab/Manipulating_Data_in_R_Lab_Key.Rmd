...
Open the `CO_heat_ER_bygender` dataset from the `dasehr` package and assign it to the name `heat_long`, selecting only the "county", "visits", "year", and "gender" columns using `%>% filter()`
