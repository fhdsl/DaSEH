...
`tseries` package for analyzing time series (https://cran.r-project.org/web/packages/tseries/index.html) or the fable` package for forecasting models (https://fable.tidyverts.org/).
