...
3. Add to this date the number of weeks given in the column `week_date`. You will have to substract one week because the first week of the year is already week 1.
...
### 3.4 Plot a timeseries of each flu season from 2015 to 2025.
Create a plot of a timeseries of each flu season from 2015 to 2025, color the lines by virus type. 
