...
Load the packages needed in this lab. Then, read in the CalEnviroScreen data and assign it to the "ces" object. You can find the data at https://daseh.org/data/CalEnviroScreen_data.csv
