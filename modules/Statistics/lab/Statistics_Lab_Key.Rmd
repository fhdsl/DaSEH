...
Load the libraries needed in this lab. Then, read in the CalEnviroScreen data from `dasehr` package. Assign it to the "ces" variable. You can also find the data at "https://daseh.org/data/CalEnvironmentalScreen_data.csv"
