...
**Thus send us a link to your data if it is hosted somewhere ** If the data is not hosted publicly somewhere, you must turn it in on Drop Box with your other files. 
