...
<span style="color:blue">We will learn more about factors in a later module.</span>
...
| 1                | integer   | integer   | Need to coerce to integer with as.integer() or use sample()/seq() with whole numbers    |
