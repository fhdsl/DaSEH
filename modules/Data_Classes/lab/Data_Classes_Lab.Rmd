...
Read in the CalEnviroScreen data using `load()` function from `dasehr` package using the code supplied in the chunk. Or alternatively using the url link.

```{r}
#calenviro <- load("data/calenviroscreen.rda")
circ <- read_csv(file = "https://daseh.org/data/CalEnvironmentalScreen_data.csv")
```
