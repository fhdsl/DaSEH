...
```{r, fig.alt="The image shows an image of an arrow pointing to the newly created R project in RStudio.", out.width = "60%", echo = FALSE, align = "center"}
knitr::include_graphics("images/Data_Input_new_project_topright.png")
```
...
```{r, fig.alt="The image shows the data in preview form. It is organized like a spreadsheet one might see in Excel.", out.width = "80%", echo = FALSE, align = "center"}
knitr::include_graphics("images/Data_Input_object_created.png")
```
