...
If we add the CalEnviroScreen_data.csv file to the R Project folder, we can use the file name for the `file` argument:
...
dat <- read_csv(file = "data/CalEnviroScreen_data.csv")
```
