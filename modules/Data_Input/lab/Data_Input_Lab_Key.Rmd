...
# If we wanted to get really in the weeds, we could do a logical test like all.equal(CalEnviroScreen, ces)
```
...
### P.2
Let's look at a dataset about nitrate levels in the WA public water system.

Download this dataset using the url https://daseh.org/data/Nitrate_Exposure_for_WA_Public_Water_Systems_data.xlsx file.  Assign it to the object name `nitrate.xlsx` by running the following code chunk. This only downloads the file, it does NOT bring the file into R.
