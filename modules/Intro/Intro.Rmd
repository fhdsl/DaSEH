...
knitr::include_graphics("https://rladies.org/images/logo-wide.svg")
```

<sub>[source: <https://rladies.org/>]</sub>
...
`r config::get("pulsecheck_survey")`
...
Make sure to try coding on your own first ("programmer thinking"). Some research suggests using LLMs can cause [deskilling](https://www.frontiersin.org/journals/medicine/articles/10.3389/fmed.2026.1765692/full).
