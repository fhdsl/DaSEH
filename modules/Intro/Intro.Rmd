...
<sub>[source: <http://www.r-project.org/>, [https://en.wikipedia.org/wiki/S\_(programming_language)](https://en.wikipedia.org/wiki/S_(programming_language)){.uri}, <https://en.wikipedia.org/wiki/Bell_Labs>)] </sub>
...
<sub>[source: <http://www.r-project.org/>, [https://en.wikipedia.org/wiki/R\_(programming_language)](https://en.wikipedia.org/wiki/R_(programming_language)){.uri}]</sub>
