...
9\. Remove any rows with missing data (NA), then filter out (i.e., remove) measurements from earlier than 2015 (according to the Earth year). Replace the original "mars" object by reassigning the new filtered dataset to "mars". How many data points are left after filtering?
