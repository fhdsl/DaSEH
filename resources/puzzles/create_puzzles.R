...
png(file="resources/puzzles/answers_search_ex.png")
plot(x, solution = TRUE, title = "Example Answers")
dev.off()
pdf(file = "resources/puzzles/example_search.pdf")
...
# raw_func_info <- readRDS(file = here::here("resources/raw_all_func_forpuzzles.rds"))
# words <- raw_func_info$`./modules/R_files/Data_Cleaning.R`$`package:naniar`
# x <- wordsearch(words, r = 20, c = 20)
# pdf(file="resources/puzzles/missing_data_search_answers.pdf")
# plot(x, solution = TRUE, title = "Missing Data Answers")
# dev.off()
# pdf(file="resources/puzzles/missing_data_search.pdf")
# plot(x, solution = FALSE, title = "Missing Data")
# dev.off()
cheatsheet_func_info <- read_csv(file = here::here("resources/all_the_functions.csv"))
...
x <- crossword(words, clues, r = 40, c = 40)
pdf(file="resources/puzzles/stringr_cross_word.pdf", width = 15)
plot(x, clues = TRUE)
dev.off()
...
dev.off()
pdf(file="resources/puzzles/string_functions_cross_word.pdf", width = 15)
